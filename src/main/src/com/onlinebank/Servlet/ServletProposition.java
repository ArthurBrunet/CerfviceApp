        ...
        List<Produit> i = Database.select(produits,produit);
            ...
            for (Produit result: i) {
                ...
                for (Prospect c : listprospect) {
                    ...
                    System.out.println("mon age cet" + age);
                    // CONDITION POUR LES 12/17
                    if (age >= result.getMinage() && age <= result.getMaxage()) {

                        System.out.println("bonjou" +result.getMinage());
                        System.out.println("bonjou" +result.getMaxage());
                        if (!c.getVerifCcp()) {
